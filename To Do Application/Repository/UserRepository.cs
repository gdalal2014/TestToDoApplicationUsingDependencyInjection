    ...
    public class UserRepository : IUserRepository
    {
        ...
        public IEnumerable<UserEntity> All()
        {
            using (var scope = _autofacContainer.BeginLifetimeScope())
            {
                ...
                "SELECT user_id, user_first_name, user_last_name, create_date, modified_date FROM todolist.users_tbl",
        ...
        public void Add(UserEntity entity)
        {
            using (var scope = _autofacContainer.BeginLifetimeScope())
            {
                ...
                "INSERT INTO todolist.users_tbl(user_first_name, user_last_name, create_date, modified_date) VALUES(@FirstName, @LastName, sysdate(), sysdate());",
        ...
        public void Update(UserEntity entity)
        {
            using (var scope = _autofacContainer.BeginLifetimeScope())
            {
                ...
                "UPDATE todolist.users_tbl SET user_first_name = @FirstName, user_last_name = @LastName, modified_date = sysdate() WHERE user_Id = @UserId",
        ...
        public IEnumerable<UserEntity> Find(string userID)
        {
            using (var scope = _autofacContainer.BeginLifetimeScope())
            {
                ...
                var _newTransaction = _uow.Begin();
                return _newTransaction.Connection.Query<UserEntity>(
                "SELECT user_id, user_first_name, user_last_name, create_date, modified_date FROM todolist.users_tbl WHERE user_id = @userID",
